...
void Example()
{
	// 정수를 저장하는 데이터타입(int) 변수를 2개 선언
	int numA = 10;
	//numB라는 녀석은 numA에 저장되어 있는 값을 B에 옮기고싶다.
	//numA의 값을 numB에 복사하고싶다.
	int numB = numA;
	// 정수의 주소를 저장하는 변수를 2개 선언
	int* numAptr = &numA;
	int* numBptr = numAptr;

	// numBptr들어간 주소와 numAptr 들어간 주소, numA의 주소 모두 같습니까?

	cout << "numA    의 값이 궁급합니다 " << &numA << endl;
	cout << "numAptr 의 값이 궁금합니다" << numAptr << endl;
	cout << "numBptr 의 값이 궁금합니다" << numBptr << endl;
